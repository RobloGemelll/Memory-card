...
questions_list.append(
        Question(' Какая планета известна как "Красная планета"?', 'Марс', 'Венера', 'Юпитер ', 'Кран'))
questions_list.append(
        Question('Какое животное является символом wisdom в культуре?', 'Сова ', 'Лев', 'Волк', 'Орёл'))
questions_list.append(
        Question('Какой вид мяса получают от свиней', 'Свинина', 'Говядина', 'Курица', 'Оленина'))
questions_list.append(
        Question('Какой из следующих городов находится в Италии?', 'Рим', 'Париж', 'Мадрид', 'Берлин'))
questions_list.append(
        Question('Какой математический символ используется для обозначения сложения?', '+', '-', '*', '÷'))
questions_list.append(
        Question('Как называется столица Японии?', 'Токио', 'Пекин', 'Сеул', 'Бангкок'))
questions_list.append(
        Question('Какой писатель является автором "Мастера и Маргариты"?', 'Михаил Булгаков', 'Фёдор Достоевский', ' Лев Толстой', 'Антон Чехов'))
questions_list.append(
        Question('Государственный язык России', 'Русский', 'Английский', 'Испанский', 'Бразильский'))
app = QApplication([])
